...
public class Main {
    ...
    private static final String MARKET = "FX";
    private static final String EXCHANGE = "IBKR";
    private static final String SYMBOL = "IBKR:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"IBKR:000040\",\"IBKR:005930\"],\"replay\":\"last\"}";
